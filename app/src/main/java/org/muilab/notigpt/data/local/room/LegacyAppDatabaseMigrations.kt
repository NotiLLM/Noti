...
/**
 * Historical Room migrations retained for installed databases below version 39.
 * Remove them only after an explicit production baseline and a verified backup of existing data.
 */
internal object LegacyAppDatabaseMigrations {

    val MIGRATION_1_2 = sqlMigration(
        1,
        2,
        """
    ...
    val MIGRATION_2_3 = sqlMigration(
        2,
        3,
        """
            CREATE VIEW IF NOT EXISTS `VisibleNotiRecord` AS 
    ...
    val MIGRATION_3_4 = sqlMigration(3, 4, "ALTER TABLE noti_drawer ADD COLUMN taskState INTEGER NOT NULL DEFAULT 0")

    val MIGRATION_4_5 = sqlMigration(4, 5, "ALTER TABLE notiAction ADD COLUMN lastAppResumeTime INTEGER NOT NULL DEFAULT 0")

    val MIGRATION_5_6 = sqlMigration(5, 6, "ALTER TABLE notiAction ADD COLUMN metadata TEXT NOT NULL DEFAULT \"\"")

    val MIGRATION_6_7 = sqlMigration(6, 7, "ALTER TABLE noti_drawer ADD COLUMN lastSyncTime INTEGER NOT NULL DEFAULT 0")

    val MIGRATION_7_8 = sqlMigration(
        7,
        8,
        """
    ...
    val MIGRATION_8_9 = sqlMigration(
        8,
        9,
        "ALTER TABLE noti_record ADD COLUMN taskScanned INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE noti_record ADD COLUMN taskExtracted INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE noti_drawer ADD COLUMN shouldExtractTask INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE noti_drawer ADD COLUMN hasGenuineTask INTEGER NOT NULL DEFAULT 0",
    )

    val MIGRATION_9_10 = sqlMigration(9, 10, "ALTER TABLE task_list ADD COLUMN userEdited INTEGER NOT NULL DEFAULT 0")

    val MIGRATION_10_11 = sqlMigration(
        10,
        11,
        "ALTER TABLE noti_record RENAME COLUMN taskDetectionChecked TO taskScanned",
        "ALTER TABLE noti_record RENAME COLUMN taskExtractionChecked TO taskExtracted",
    )

    val MIGRATION_11_12 = sqlMigration(
        11,
        12,
        "ALTER TABLE noti_record ADD COLUMN taskExtractionClaimed INTEGER NOT NULL DEFAULT 0",
    )

    val MIGRATION_12_13 = sqlMigration(
        12,
        13,
        "ALTER TABLE noti_record ADD COLUMN taskExtractionClaimedAt INTEGER NOT NULL DEFAULT 0",
    )
    ...
    val MIGRATION_15_16 = sqlMigration(
        15,
        16,
        "ALTER TABLE noti_drawer ADD COLUMN isSetToTop INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE noti_drawer ADD COLUMN setToTopTime INTEGER NOT NULL DEFAULT 0",
    )
     ...
     */
    val MIGRATION_17_18 = sqlMigration(17, 18)
    val MIGRATION_18_19 = sqlMigration(18, 19)
    val MIGRATION_19_20 = sqlMigration(19, 20)
    val MIGRATION_20_21 = sqlMigration(20, 21)

    // Manual drawer ordering: -1 means unset.
    val MIGRATION_21_22 = sqlMigration(
        21,
        22,
        "ALTER TABLE noti_drawer ADD COLUMN sortPosition INTEGER NOT NULL DEFAULT -1",
    )
    ...
    val MIGRATION_23_24 = Migration(23, 24) { db ->
        db.execSQL(
            """
    ...
    val MIGRATION_24_25 = sqlMigration(
        24,
        25,
        "ALTER TABLE saved_item ADD COLUMN sourceExtractionSnapshotId TEXT",
    )

    val MIGRATION_25_26 = Migration(25, 26) { db ->
    ...
    val MIGRATION_26_27 = sqlMigration(
        26,
        27,
        "ALTER TABLE saved_item ADD COLUMN isVisible INTEGER NOT NULL DEFAULT 1",
    )

    val MIGRATION_27_28 = sqlMigration(
        27,
        28,
        "ALTER TABLE saved_item ADD COLUMN origin TEXT NOT NULL DEFAULT 'manual'",
        "ALTER TABLE saved_item ADD COLUMN humanEditCount INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE saved_item ADD COLUMN deletedAtMs INTEGER",
    )

    val MIGRATION_28_29 = Migration(28, 29) { db ->
        db.execSQL(
    ...
    val MIGRATION_29_30 = Migration(29, 30) { db ->
        db.execSQL(
    ...
    val MIGRATION_30_31 = sqlMigration(
        30,
        31,
        "ALTER TABLE saved_item ADD COLUMN isEvent INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE saved_item ADD COLUMN startAtMs INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE saved_item ADD COLUMN endAtMs INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE noti_drawer ADD COLUMN hasEvent INTEGER NOT NULL DEFAULT 0",
    )

    val MIGRATION_31_32 = sqlMigration(
        31,
        32,
        "ALTER TABLE saved_item ADD COLUMN buttons TEXT NOT NULL DEFAULT '[]'",
        "ALTER TABLE saved_item ADD COLUMN isViewed INTEGER NOT NULL DEFAULT 1",
        "ALTER TABLE saved_item ADD COLUMN isPinned INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE saved_item ADD COLUMN sortScore REAL NOT NULL DEFAULT 50.0",
        "ALTER TABLE saved_item ADD COLUMN reRankHistory TEXT NOT NULL DEFAULT '[]'",
    )

    val MIGRATION_32_33 = Migration(32, 33) { db ->
        db.execSQL(
    ...
    val MIGRATION_33_34 = Migration(33, 34) { db ->
        db.execSQL(
    ...
    val MIGRATION_34_35 = sqlMigration(
        34,
        35,
        "DROP INDEX IF EXISTS `idx_esm_status_available`",
        "DROP INDEX IF EXISTS `idx_esm_status_expires`",
        "DROP INDEX IF EXISTS `idx_esm_savedItemId`",
        "DROP INDEX IF EXISTS `idx_esm_answer_instance`",
        "DROP TABLE IF EXISTS `esm_answer_event`",
        "DROP TABLE IF EXISTS `esm_instance`",
    )

    val MIGRATION_35_36 = Migration(35, 36) { db ->
    ...
    val MIGRATION_36_37 = Migration(36, 37) { db ->
        db.execSQL(
            """
    ...
    val MIGRATION_37_38 = Migration(37, 38) { db ->
        db.execSQL(
            """
    ...
    val MIGRATION_38_39 = Migration(38, 39) { db ->
        db.execSQL("DROP VIEW IF EXISTS `VisibleNotiRecord`")
